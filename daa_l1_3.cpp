...
// Finding max, secmax, min, secmin in array using 2-way approach
// Lab 1, 3rd problem - 2 way approach
...
class findmax
{
    ...
    public:
        ...
        {
            cout << "The max element in the array is: " << arr[size - 1] << endl;
            cout << "The secondary max element in the array is: " << arr[size - 2] << endl;
            cout << "The min element in tha array is: " << arr[0] << endl;
            cout << "The secondary min element in tha array is: " << arr[1] << endl;
            cout << endl;
        }
